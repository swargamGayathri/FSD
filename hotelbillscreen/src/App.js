...
const HotelBillScreen = () => {
  ...
  const calculateTotalCost = () => {
    return transactions.reduce(
      (total, transaction) => total + transaction.quantity * transaction.costPerItem,
      0
    );
  };
...
const handlePrint = () => {
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: 'center', color: '#333' }}>Teddy Hotel Invoice</h2>
  ...
  >
    Add Item
      ...
      <div className="watermark">S.Gayathri</div>
    </div>
  );
};
